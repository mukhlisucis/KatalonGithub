...
public class Testrail {
	...
	def get_tests(String id) {
		...
		ro.setRestUrl('https://adirafinance.testrail.io/index.php?/api/v2/get_tests/'+id)
		...
		httpheader.add(new TestObjectProperty(
				...
				'Basic ZGlhaC5wcmF0aXdpQGFkaXJhLmNvLmlkOjExRGVzZW1iZXIu'))
	...
	def update_run(String id, String array) {
		...
		ro.setRestUrl('https://adirafinance.testrail.io/index.php?/api/v2/update_run/'+id)
		def httpheader = new ArrayList<TestObjectProperty>()
		httpheader.add(new TestObjectProperty(
				'Content-Type', ConditionType.EQUALS, 'application/json'))
		httpheader.add(new TestObjectProperty(
	...
	def add_results(String id, String request) {
		...
		RequestObject ro = new RequestObject('a')
		ro.setRestRequestMethod('POST')
		ro.setRestUrl('https://adirafinance.testrail.io/index.php?/api/v2/add_results_for_cases/'+id)
		def httpheader = new ArrayList<TestObjectProperty>()
		httpheader.add(new TestObjectProperty(
				'Content-Type', ConditionType.EQUALS, 'application/json'))
		httpheader.add(new TestObjectProperty(

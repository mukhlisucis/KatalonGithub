...
'memastikan button ganti password terlihat pada layar user'
...
'memastikan label ubah kata sandi terlihat pada layar ganti password'
...
'memastikan label password lama terlihat pada layar ganti password'
WebUI.verifyElementVisible(findTestObject('Web Mobile Object/Page_Ganti Password/label_PasswordLama'))

'memastikan textbox input password lama terlihat pada layar ganti password'
WebUI.verifyElementVisible(findTestObject('Web Mobile Object/Page_Ganti Password/textbox_InputOldPassword'))

'input password lama'
WebUI.setText(findTestObject('Web Mobile Object/Page_Ganti Password/textbox_InputOldPassword'), GlobalVariable.passwordLama)
...
'memastikan textbox password baru terlihat pada layar ganti password'
...
//CustomKeywords.'aksesApp.LibJosh.addGlobalVariable'('passwordBaru', newPassword)
'Add global variable floating passeord baru'
CustomKeywords.'general.addGlobalVariable.addGlobalVariableFloating'('passwordBaru', newPassword)

'memastikan label konfirmasi password terlihat pada layar ganti password'
WebUI.verifyElementVisible(findTestObject('Web Mobile Object/Page_Ganti Password/label_KonfirmasiNewPass'))

'memastikan textbox konfirmasi password terlihat pada layar ganti password'
WebUI.verifyElementVisible(findTestObject('Web Mobile Object/Page_Ganti Password/textbox_ConfirmNewPass'))

'input confirm password '
WebUI.setText(findTestObject('Web Mobile Object/Page_Ganti Password/textbox_ConfirmNewPass'), newPassword)
...
'melakukan screenshot pada layar ganti password'
WebUI.takeScreenshot()

'memastikan button ubah password bisa di click'
WebUI.verifyElementClickable(findTestObject('Web Mobile Object/Page_Ganti Password/button_UbahPassword'))

'melakukan klik pada button ubah password'
WebUI.click(findTestObject('Web Mobile Object/Page_Ganti Password/button_UbahPassword'))

'memastikan notifikasi password berhasil di ganti muncul pada layar akun'
WebUI.verifyElementVisible(findTestObject('Web Mobile Object/Page_Ganti Password/label_PasswordBerhasilGanti'))

'mengambil screenshot'
WebUI.takeScreenshotAsCheckpoint('ubah password valid value')

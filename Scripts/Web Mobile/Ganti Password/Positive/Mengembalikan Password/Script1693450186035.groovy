...
'memastikan button akun muncul pada layar dashboard'
WebUI.verifyElementVisible(findTestObject('Web Mobile Object/Page_Akun/button_Akun'))

'melakukan klik pada button akun'
WebUI.click(findTestObject('Web Mobile Object/Page_Akun/button_Akun'))

'memastikan nama er terlihat pada layar menu user'
WebUI.verifyElementVisible(findTestObject('Web Mobile Object/Page_Akun/label_NamaUser'))

'memastkan label menu moservice terlihat pada layar menu user'
WebUI.verifyElementVisible(findTestObject('Web Mobile Object/Page_Akun/label_MenuMoservice'))
...
'melakukan scroll ke button logout'
...
'input password lama'
WebUI.setText(findTestObject('Web Mobile Object/Page_Ganti Password/textbox_InputOldPassword'), GlobalVariable.passwordBaru)
...
'input password baru'
WebUI.setText(findTestObject('Web Mobile Object/Page_Ganti Password/textbox_InputNewPassword'), GlobalVariable.passwordLama)
...
WebUI.setText(findTestObject('Web Mobile Object/Page_Ganti Password/textbox_ConfirmNewPass'), GlobalVariable.passwordLama)

...
WebUI.setText(findTestObject('Web Mobile Object/Page_Login/textbox_InputEmailPhone'), email)
...
'memastikan alert email/phone number invalid muncul pada layar login'
...
WebUI.takeScreenshotAsCheckpoint('login invalid format 1')
...
'input phoneNumber pada field input email/nomor hp'
WebUI.setText(findTestObject('Web Mobile Object/Page_Login/textbox_InputEmailPhone'), email2)
...
'mengambil screenshot pada layar login'
WebUI.takeScreenshotAsCheckpoint('login invalid format 2')
...
'input phoneNumber pada field input email/nomor hp'
WebUI.setText(findTestObject('Web Mobile Object/Page_Login/textbox_InputEmailPhone'), email3)
...
'mengambil screenshot pada layar login'
WebUI.takeScreenshotAsCheckpoint('login invalid format 3')

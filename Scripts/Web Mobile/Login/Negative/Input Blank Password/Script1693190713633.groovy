...
'memastikan textbox input email terlihat pada layar login'
WebUI.verifyElementVisible(findTestObject('Web Mobile Object/Page_Login/textbox_InputEmailPhone'))

'melakukan input phoneNumber pada field nomor hp'
...
WebUI.takeScreenshotAsCheckpoint('login blank password')

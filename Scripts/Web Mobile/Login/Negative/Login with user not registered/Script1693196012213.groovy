...
'input phoneNumber unregistered pada field input email/nomor hp'
...
'memastikan bahwa alert telah terlihat pada layar login'
WebUI.verifyAlertPresent(0)

'menyimpan value dari alert tersebut'
alert = WebUI.getAlertText()

//println(alert)
'membandingkan antara value alert, dan harus sama'
WebUI.verifyMatch(alert, 'Data user tidak ditemukan', true)

'melakukan click pada button ok di alert yang telah muncul'
WebUI.acceptAlert()

'melakukan screenshot pada layar login'
WebUI.takeScreenshotAsCheckpoint('login user unregistered')

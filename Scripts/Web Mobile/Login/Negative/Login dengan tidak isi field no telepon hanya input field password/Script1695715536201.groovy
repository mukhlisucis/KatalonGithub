...
'click textbox nomor hp untuk triggered alert muncul'
WebUI.click(findTestObject('Web Mobile Object/Page_Login/New Login/textbox_phoneNumber'), FailureHandling.STOP_ON_FAILURE)

'melakukan input valid password'

...
'menyimpan variable password kedalam floating GlobalVariable passwordLama'
CustomKeywords.'general.addGlobalVariable.addGlobalVariableFloating'('passwordLama', password)
...
'melakukan click pada button eye password untuk melihat value dari inputan password'
WebUI.click(findTestObject('Web Mobile Object/Page_Register/button_EyePassword'))

'menyimpan tribute sesudah di click pada input password dan disimpan pada variable typeAfterClick'
typeAfterClick = WebUI.getAttribute(findTestObject('Web Mobile Object/Page_Login/textboxt_InputPassword'), 'type')

//'memastikan value typeAfterClick harus sama dengan text'
//assertEquals(typeAfterClick, 'text')
'memastikan value typeAfterClick harus sama dengan password'
WebUI.verifyMatch(typeAfterClick, 'text', true)

'mengambil screenshot pada layar login'
WebUI.takeScreenshotAsCheckpoint('login tap eye')
...
'memastikan label Cari service muncul pada layar login'
WebUI.verifyElementVisible(findTestObject('Web Mobile Object/Page_Dashboard/label_CariService'))

'memastikan label header moservice muncul pada layar login'
WebUI.verifyElementVisible(findTestObject('Web Mobile Object/Page_Dashboard/label_HeaderMoservice'))

'memastikan button beranda muncul pada layar login'
WebUI.verifyElementVisible(findTestObject('Web Mobile Object/Page_Dashboard/button_Beranda'))

'memastikan button masuk akun muncul pada layar login'
WebUI.verifyElementVisible(findTestObject('Web Mobile Object/Page_Akun/button_Akun'))

'memastikan label akun pada button akun muncul pada layar login'
WebUI.verifyElementVisible(findTestObject('Web Mobile Object/Page_Login/label_Akun'))

'mengambil screenshot pada layar login'
WebUI.takeScreenshotAsCheckpoint('login tap eye redirect to dashboard')

...
'input nomor hp user'
WebUI.setText(findTestObject('Web Mobile Object/Page_Register/New Register/textbox_phoneNumber'), phoneNumber)

'menutup keyboard'
Mobile.hideKeyboard()

'click input password'
WebUI.click(findTestObject('Web Mobile Object/Page_Register/New Register/textbox_Password'), FailureHandling.STOP_ON_FAILURE)

'menutup keyboard'
Mobile.hideKeyboard()

'click input konfirm password'
WebUI.click(findTestObject('Web Mobile Object/Page_Register/New Register/textbox_konfirmasiPassword'), FailureHandling.STOP_ON_FAILURE)
...
'memastikan alert invalid password terlihat pada layar'
WebUI.verifyElementVisible(findTestObject('Web Mobile Object/Page_Register/New Register/label_alertPasswordInvalid'))

'screenshot register password null value'
WebUI.takeScreenshotAsCheckpoint('register password null value')

...
'memastikan button daftar dapat di click'
WebUI.verifyElementClickable(findTestObject('Web Mobile Object/Page_Register/New Register/button_Daftar'))

WebUI.click(findTestObject('Web Mobile Object/Page_Register/New Register/button_Daftar'))

WebUI.waitForAlert(0)

alertNomorTerdaftar = WebUI.getAlertText()

WebUI.verifyMatch('Nomor Ponsel sudah terdaftar', alertNomorTerdaftar, false)

println(alertNomorTerdaftar)

WebUI.acceptAlert()

'mengambil screenshot pada layar registrasi'
WebUI.takeScreenshotAsCheckpoint('Register with Registered User')

...
'melakukan input password dengan invalid format pada field password'
...
'memastikan button eye pada password muncul'
WebUI.verifyElementVisible(findTestObject('Web Mobile Object/Page_Register/button_EyePassword'))

'melakukan click pada button eye pada password'
WebUI.click(findTestObject('Web Mobile Object/Page_Register/button_EyePassword'))

'memastikan alert invalid password muncul pada layar registrasi'
WebUI.verifyElementVisible(findTestObject('Web Mobile Object/Page_Register/label_AlertPassword'))
...
WebUI.takeScreenshotAsCheckpoint('register invalid format password')
